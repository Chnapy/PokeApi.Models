...
public partial class PokemonColor
{
    ...
    public const string FileEndpoint = "/api/v2/pokemon-color/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/pokemon-color/index.json";
    ...
    public const string RestEndpoint = "/api/v2/pokemon-color/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/pokemon-color/";
}
