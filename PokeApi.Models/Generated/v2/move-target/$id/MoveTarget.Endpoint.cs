...
public partial class MoveTarget
{
    ...
    public const string FileEndpoint = "/api/v2/move-target/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/move-target/index.json";
    ...
    public const string RestEndpoint = "/api/v2/move-target/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/move-target/";
}
