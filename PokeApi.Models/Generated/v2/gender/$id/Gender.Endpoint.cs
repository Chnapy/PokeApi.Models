...
public partial class Gender
{
    ...
    public const string FileEndpoint = "/api/v2/gender/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/gender/index.json";
    ...
    public const string RestEndpoint = "/api/v2/gender/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/gender/";
}
