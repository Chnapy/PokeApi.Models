...
public partial class VersionGroup
{
    ...
    public const string FileEndpoint = "/api/v2/version-group/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/version-group/index.json";
    ...
    public const string RestEndpoint = "/api/v2/version-group/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/version-group/";
}
