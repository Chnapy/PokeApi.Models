...
public partial class TypeBrilliantDiamondShiningPearl
{
    /// <summary>PokeAPI/api-data file endpoint for this resource.</summary>
    public const string FileEndpoint = "/api/v2/type/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/type/index.json";
    ...
    public const string RestEndpoint = "/api/v2/type/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/type/";
}
