...
public partial class MoveCategory
{
    ...
    public const string FileEndpoint = "/api/v2/move-category/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/move-category/index.json";
    ...
    public const string RestEndpoint = "/api/v2/move-category/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/move-category/";
}
