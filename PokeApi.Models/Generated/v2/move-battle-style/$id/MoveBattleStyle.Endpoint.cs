...
public partial class MoveBattleStyle
{
    ...
    public const string FileEndpoint = "/api/v2/move-battle-style/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/move-battle-style/index.json";
    ...
    public const string RestEndpoint = "/api/v2/move-battle-style/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/move-battle-style/";
}
