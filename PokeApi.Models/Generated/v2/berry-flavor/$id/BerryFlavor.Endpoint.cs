...
public partial class BerryFlavor
{
    ...
    public const string FileEndpoint = "/api/v2/berry-flavor/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/berry-flavor/index.json";
    ...
    public const string RestEndpoint = "/api/v2/berry-flavor/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/berry-flavor/";
}
