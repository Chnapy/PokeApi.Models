...
public partial class GenerationGameIndex
{
    /// <summary>PokeAPI/api-data file endpoint for this resource.</summary>
    public const string FileEndpoint = "/api/v2/generation_game_index.json";
    ...
    public const string RestEndpoint = "/api/v2/generation_game_";
