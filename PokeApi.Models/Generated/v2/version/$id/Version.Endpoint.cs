...
public partial class Version
{
    ...
    public const string FileEndpoint = "/api/v2/version/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/version/index.json";
    ...
    public const string RestEndpoint = "/api/v2/version/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/version/";
}
