...
public partial class Generation
{
    ...
    public const string FileEndpoint = "/api/v2/generation/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/generation/index.json";
    ...
    public const string RestEndpoint = "/api/v2/generation/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/generation/";
}
