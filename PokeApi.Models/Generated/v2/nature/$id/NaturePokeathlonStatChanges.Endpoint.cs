...
public partial class NaturePokeathlonStatChanges
{
    ...
    public const string FileEndpoint = "/api/v2/nature/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/nature/index.json";
    ...
    public const string RestEndpoint = "/api/v2/nature/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/nature/";
}
