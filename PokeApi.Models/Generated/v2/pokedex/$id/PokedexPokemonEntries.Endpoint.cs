...
public partial class PokedexPokemonEntries
{
    /// <summary>PokeAPI/api-data file endpoint for this resource.</summary>
    public const string FileEndpoint = "/api/v2/pokedex/$id/index.json";
    
    /// <summary>PokeAPI/api-data file list endpoint for this resource.</summary>
    public const string FileEndpointList = "/api/v2/pokedex/index.json";
    ...
    public const string RestEndpoint = "/api/v2/pokedex/{id}/";
    
    /// <summary>PokeAPI REST list endpoint for this resource.</summary>
    public const string RestEndpointList = "/api/v2/pokedex/";
}
