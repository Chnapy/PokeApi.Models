...
public partial class MoveAilment1
{
    /// <summary>PokeAPI/api-data file endpoint for this resource.</summary>
    public const string FileEndpoint = "/api/v2/move-ailment/-1/index.json";
    ...
    public const string RestEndpoint = "/api/v2/move-ailment/-1/";
